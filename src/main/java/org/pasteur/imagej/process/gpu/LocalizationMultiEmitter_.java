...
public class LocalizationMultiEmitter_ {
    ...
    double [][] sortedLikelihood;//the likelihood sorted in increasing order according to each individual ; second dim=2: likelihood&index
    double [][] thetaX;
    double [][] thetaY;
    double [][] thetaZ;
    double [] thetaZfocus;
    ...
    private void localizationMultiEmitter_(int iterMax,double minZ, double maxZ,int popsize,int popsizeSelection,int numberPSFperModel){
        ...
        sortedLikelihood=new double [popsize][2];
    ...
    public boolean localize(){
        ...
        this.computeMeanStdOverPopulation();
        for (int i=0;i<this.numberPSFperModel;i++){
            IJ.log("mean ->  =  "+meanA[0][i]+"  "+meanB[0][i]+"  "+meanX[i]+"  "+meanY[i]+"  "+meanZ[i]+"  ");
        }
    ...
    public void computeSortedLikelihood(){
