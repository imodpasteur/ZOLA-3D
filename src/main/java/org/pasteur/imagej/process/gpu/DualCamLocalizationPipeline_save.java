 ...
 * @author benoit
 */
public class DualCamLocalizationPipeline_save {
    ...
    public DualCamLocalizationPipeline_save(String imageCam1,StackLocalization sl1,DataPhase_ dp1,String imageCam2,StackLocalization sl2,DataPhase_ dp2,String pathResFusion,double maxDistanceMergingXY,int nbStream, int nbThread,double adu1, double gain1,double offset1,double adu2, double gain2,double offset2){
    ...
    public boolean register(){
        ...
        if (nbData>4){
            ...
            if (notApparied){
                ...
                pf.a[0][5]=0;
                pf.a[0][6]=0;
                IJ.log("WARNING  WARNING  WARNING  WARNING   no automatic registration");IJ.log("WARNING  WARNING  WARNING  WARNING   no automatic registration");IJ.log("WARNING  WARNING  WARNING  WARNING   no automatic registration");IJ.log("WARNING  WARNING  WARNING  WARNING   no automatic registration");
                pf.a[1][0]=0;
                pf.a[1][1]=0;
                pf.a[1][2]=0;
                pf.a[1][3]=1;
                ...
                pfinit.a[0][5]=0;
                pfinit.a[0][6]=0;
                IJ.log("WARNING  WARNING  WARNING  WARNING   no automatic registration");IJ.log("WARNING  WARNING  WARNING  WARNING   no automatic registration");IJ.log("WARNING  WARNING  WARNING  WARNING   no automatic registration");IJ.log("WARNING  WARNING  WARNING  WARNING   no automatic registration");IJ.log("WARNING  WARNING  WARNING  WARNING   no automatic registration");IJ.log("WARNING  WARNING  WARNING  WARNING   no automatic registration");
                pfinit.a[1][0]=0;
                pfinit.a[1][1]=0;
                pfinit.a[1][2]=0;
                pfinit.a[1][3]=1;
        ...
        public void run(){
           ...
           for (int i=idStream*nbThread+idThread,t=0;i<sl1fuse.fl.size();i+=nbStream*nbThread){//Here, each stream process different images
               ...
               //for (int j=0;j<Math.min(sl1fuse.fl.get(i).loc.size(), 2);j++){IJ.log("WARNING: DualCamLoc: 2 loc per frame only");
                ...
                IJ.log("numberPerStream "+nbStream+"  "+numberPerStream);
                 try{
                     lock.lock();
                     stackloc.fl.add(fl);
