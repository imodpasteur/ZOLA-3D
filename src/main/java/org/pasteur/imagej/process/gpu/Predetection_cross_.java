 ...
 * @author benoit
 */
public class Predetection_cross_ {
    ...
    public Predetection_cross_(int sizeFullImage, DataPhase_ dparam,double mini, double maxi, double step,double thresholdCrossCorrelation){
