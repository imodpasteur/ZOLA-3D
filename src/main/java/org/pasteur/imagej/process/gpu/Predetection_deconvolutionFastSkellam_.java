 ...
 * @author benoit
 */
public class Predetection_deconvolutionFastSkellam_ {
    
    boolean withSkellam=true;
    ...
    public Predetection_deconvolutionFastSkellam_(int width,int height, DataPhase_ dparam,double mini, double maxi, double step ){
    ...
    public double [][] deconvolution_RL(){
        ...
        toto:for (int t=0;t<this.nb_iter;t++){
            ...
            if (nb_iter-1==t) dparam.psf.imshow(wh*nbFrame,height, device_tmpFFT1, "o*psf+b"+t,"FLOAT");
            ...
            if (((t>0) & withSkellam)){
                ...
                if (t==nb_iter-1) dparam.psf.imshow(wh*(nbFrame + nbFrame + nbFrame),height, device_tmpFFT2, "XXX  "+t,"FLOAT");
                ...
                ////next 3 lines, in replacement to the previous allow to process only skellam (to test)
                ...
                if (t==nb_iter-1) dparam.psf.imshow(wh*(nbFrame + nbFrame + nbFrame),height, device_tmpFFT2, "YYY  "+t,"FLOAT");
