...
public class LocalizationPipeline {
    ...
    public LocalizationPipeline(DataPhase dp,double axialRange,int photonThreshold,int sizePatch,String path_localization,double adu, double gain,double offset){
    
        isSCMOS=false;
        this.rescale_slope=adu/gain;
        this.rescale_intercept=-offset*adu/gain;
        
        localizationPipeline(dp,axialRange,photonThreshold,sizePatch,path_localization);
        
    }
    
    public LocalizationPipeline(DataPhase dp,double axialRange,int photonThreshold,int sizePatch,String path_localization,double [][] scmosvariance,double [][] scmosgain,double [][] scmosoffset,double [][] scmosvargain){
    ...
    void localizationPipeline(DataPhase dp,double axialRange,int photonThreshold,int sizePatch,String path_localization){
...
//                                            globalmask[imageNumber][maxs[2]+j][maxs[3]+jj]=psf[i][ii];
