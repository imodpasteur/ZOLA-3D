...
public class Simulation2Obj {
    ...
    public Simulation2Obj(DataPhase_ dp,double axialRange,double photonNumber, double background,int patchSize){
    ...
    public void run(){
        ...
        zposition[1]=position+(theposition+.1)*cameraFlip;
        zposition[2]=position+(theposition+.1)*cameraFlip;
        zposition[3]=position+(theposition+.1)*cameraFlip;
        zposition[4]=position+(theposition-.1)*cameraFlip;
        zposition[5]=position+(theposition-.1)*cameraFlip;
        zposition[6]=position+(theposition-.1)*cameraFlip;
        zposition[7]=position+(theposition-.1)*cameraFlip;
        
        zposition[8]=position+theposition*cameraFlip;
        zposition[9]=position+theposition*cameraFlip;
        
        zposition[10]=position+(theposition-.1)*cameraFlip;
        zposition[11]=position+(theposition-.1)*cameraFlip;
        zposition[12]=position+(theposition-.1)*cameraFlip;
        zposition[13]=position+(theposition-.1)*cameraFlip;
        zposition[14]=position+(theposition+.1)*cameraFlip;
        zposition[15]=position+(theposition+.1)*cameraFlip;
        zposition[16]=position+(theposition+.1)*cameraFlip;
        zposition[17]=position+(theposition+.1)*cameraFlip;
        ...
        xshift[0]=patchSize;
        xshift[1]=patchSize;
        xshift[2]=8*patchSize;
        xshift[3]=8*patchSize;
        xshift[4]=patchSize;
        xshift[5]=4*patchSize;
        xshift[6]=8*patchSize;
        ...
        if (nb>0){
            ...
            double [][][] imFull = new double [nbDistance][patchSize*10][patchSize*10];
            double [][][] imFullNoise = new double [nbDistance][patchSize*10][patchSize*10];
